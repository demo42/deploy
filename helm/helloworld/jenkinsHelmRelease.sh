...
case $REPOSITORY in
  demo42/helloworld*)
    echo helm upgrade helloworld ./helm/helloworld/ --reuse-values --set helloworld.image=$HOST/$REPOSITORY:$TAG 
    helm upgrade helloworld ./helm/helloworld/ --reuse-values --set helloworld.image=$HOST/$REPOSITORY:$TAG 
